...
def generate_loader(cfg: dict) -> str:
    ...
    a = parts.append
    a("--[[")
    a("    STAND BOT LOADER - Hood Customs")
    a("    Generated by Discord config bot")
    a("    Run on OWNER + ALL ALTS")
    a("]]")
    a("")
    ...
    a("")
    a("local ok, err = pcall(function()")
    a("    loadstring(game:HttpGet(MAIN_URL))()")
    a("end)")
    a("")
    a("if not ok then")
