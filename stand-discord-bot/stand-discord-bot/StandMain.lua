--[[
    ...
    Run via loader on owner + all alts in the same server.
]]
...
print("[Stand] Main loaded |", IsOwner and "OWNER" or ("ALT slot " .. tostring(MySlot)), "| prefix", Prefix)
if IsOwner then notify("Owner ready — command alts with " .. Prefix .. "help") end
